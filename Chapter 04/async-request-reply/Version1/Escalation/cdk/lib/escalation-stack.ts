...
import { DynamoAttributeValue, DynamoPutItem, SnsPublish } from 'aws-cdk-lib/aws-stepfunctions-tasks';
...
export class EscalationStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const resultTopic = new Topic(this, 'EscalationResultTopic');
    ...
    const pushResult = new SnsPublish(this, 'PushEscalationResultStep', {
      topic: resultTopic,
    ...
    const workflowDefinition = ddbPutItemStep.next(waitStep).next(pushResult);
    ...
    new StringParameter(this, 'EscalationAssignmentBrokerArnParameter', {
      parameterName: '/escalation/broker/topic/arn',
      stringValue: resultTopic.topicArn
    });
  }
}
