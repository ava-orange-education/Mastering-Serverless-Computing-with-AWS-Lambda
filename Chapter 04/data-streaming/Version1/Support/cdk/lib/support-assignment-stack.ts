...
export class SupportAssignmentStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
	...
	const dataStream = new Stream(this, 'AssignmentDataStream', {
	  streamName: 'assignment-data-stream',
	  shardCount: 1,
	});
	...
	const functionLogGroup = new LogGroup(this, 'AssignmentFunctionLogGroup', {
	...
	new CfnPipe(this, 'HighPriorityPipe', {
	  ...
	  target: dataStream.streamArn,
	  targetParameters: {
			kinesisStreamParameters: {
				partitionKey: EventField.fromPath('$.dynamodb.NewImage.ticketId.S'),
			},
			inputTemplate: `
				{
	...
	new StringParameter(this, 'AssignmentLowDataStreamArnParameter', {
	  parameterName: '/assignment/datastream/arn',
	  stringValue: dataStream.streamArn
	});
	...
	dataStream.grantWrite(pipeRole);
  }
}
