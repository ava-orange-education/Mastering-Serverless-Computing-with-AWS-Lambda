...
import { Architecture, Runtime, IVersion, Version, Alias } from 'aws-cdk-lib/aws-lambda';
...
export class CdkStack extends Stack {
  constructor(scope: Construct, id: string, props?: StackProps) {
    ...
    const version1 = new Version(this, 'CreateItemFunctionVersion', {
      lambda: createItemFunction,
      removalPolicy: RemovalPolicy.DESTROY,
    });

    const version2 = new Version(this, 'CreateItemFunctionVersion2', {
      lambda: createItemFunction,
      removalPolicy: RemovalPolicy.DESTROY,
    });

    const aliasLive = new Alias(this, 'CreateItemFunctionAlias', {
      aliasName: 'live',
      version: version2,
      additionalVersions: [
        {
